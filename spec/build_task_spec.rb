...
describe MaestroDev::JenkinsWorker do
  ...
  describe 'build()' do
    ...
    it "should supply error when job fails to be created" do
      ...
      subject.error.should eql("Failed to create job Buildaroo: JenkinsApi::Exceptions::InternelServerErrorException, Error: Internel Server Error. Perhaps the in-memory configuration of Jenkins is different from the disk configuration. Please try to reload the configuration ")
    end
